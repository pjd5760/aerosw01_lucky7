...
% Total_Burned_cal = walking_cal(Time,speed,Body Wegiht)
...
% 직접 speed구했다면 T벡터 크기가 하나 작음 speed구하려면 t2,t1필요함. 다르다면 43번째 줄 수정 필요

% script용도 주석 네이버 기준 80kg 60분 walking 319kcal소모
clear;clc
T = 0:1:3600;
